...
```
    ...
    ## Installing package into 'C:/Users/jessi/AppData/Local/R/win-library/4.3'
...
```
    ...
    ## dbplyr      (2.3.3 -> 2.3.4) [CRAN]

    ## Installing 7 packages: withr, openssl, rmarkdown, knitr, prettyunits, lubridate, dbplyr

    ## Installing packages into 'C:/Users/jessi/AppData/Local/R/win-library/4.3'
    ## (as 'lib' is unspecified)
    ...
    ## C:\Users\jessi\AppData\Local\R\win-library\4.3\00LOCK\lubridate\libs\x64\lubridate.dll
    ## to
    ## C:\Users\jessi\AppData\Local\R\win-library\4.3\lubridate\libs\x64\lubridate.dll:
    ## Permission denied
    ...
    ##  C:\Users\jessi\AppData\Local\Temp\RtmpIfOOBM\downloaded_packages

    ## installing the source packages 'withr', 'dbplyr'

    ## ── R CMD build ─────────────────────────────────────────────────────────────────
    ##          checking for file 'C:\Users\jessi\AppData\Local\Temp\RtmpIfOOBM\remotes59a844fc2693\JoeyBernhardt-singer-2b4fe9c/DESCRIPTION' ...  ✔  checking for file 'C:\Users\jessi\AppData\Local\Temp\RtmpIfOOBM\remotes59a844fc2693\JoeyBernhardt-singer-2b4fe9c/DESCRIPTION'
    ##       ─  preparing 'singer':
...
``` r
# changes load.packages to install.packages
# added quotes around package names 
```
...
``` r
#changed dim (R function) to glimpse (dplyr function)
```
...
``` r
# used everything function to call all columns other than title and genres instead of listing them one by one
```
